  ...
  return (
    <TouchableWithoutFeedback onPress={handleOutsidePress}>
      <View style={styles.container}>
        <Animated.Image source={require('../assets/Servico_Logo_Bg.jpeg')} style={[styles.mainBackground, { transform: [{ rotate }] }]} />
        {/* Hamburger Menu */}
        <Animated.View style={[styles.hamburgerMenu, { transform: [{ translateX: menuAnim }] }]}>
          <Image source={require('../assets/hamburger_Bg.jpg')} style={styles.menuBackground} />
          ...
          <TouchableOpacity onPress={() => handleMenuNavigation('CustomerSupport')} style={styles.menuItem}>
            <Image source={require('../assets/support.png')} style={styles.menuItemIcon} />
          ...
          <TouchableOpacity onPress={() => handleMenuNavigation('TermsConditions')} style={styles.menuItem}>
            <Image source={require('../assets/terms_and_conditions.png')} style={styles.menuItemIcon} />
        ...
        <View style={styles.headerContainer}>
          ...
          <Image source={require('../assets/Servico_Logo.png')} style={styles.logo} />
        </View>
        ...
        >
          ...
          <View style={styles.animatedTextContainer}>
            <Animated.Text style={[styles.catchyText, { opacity: fadeAnim }]}>
              Hire Professionals at your door Steps with SERVICO
            </Animated.Text>
          </View>
